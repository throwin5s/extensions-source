package eu.kanade.tachiyomi.extension.en.comixselfhosted
...
abstract class Comix :
    ...
    private suspend fun getWebViewChapterList(
        ...
        return buildChapters(payload.parseAs(), mangaSlug, manga)
    }

    private fun buildChapters(allChapters: List<Chapter>, mangaSlug: String, manga: SManga): List<SChapter> {
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) {
        ...
        SwitchPreferenceCompat(screen.context).apply {
            ...
            title = "Use Scanlator Priority"
            summary = "Enable scanlator priority deduplication. Higher priority scanlators are preferred."
        ...
        EditTextPreference(screen.context).apply {
            ...
            summary = "Comma-separated list of scanlator names in priority order."
            dialogTitle = "Scanlator priority order"
            setDefaultValue("")
        }.let(screen::addPreference)
